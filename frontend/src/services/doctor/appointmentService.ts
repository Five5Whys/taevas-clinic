...
export const appointmentService = {
  getAll: async (params: any = {}) => { const r = await api.get('/doctor/appointments', { params }); return r.data.data?.content ?? r.data.data; },
  ...
  create: async (data: any) => { const r = await api.post('/doctor/appointments', data); return r.data.data; },
};
