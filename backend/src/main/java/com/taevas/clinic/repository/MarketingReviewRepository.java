...
import com.taevas.clinic.model.MarketingReview;
...
@Repository
public interface MarketingReviewRepository extends JpaRepository<MarketingReview, UUID>, JpaSpecificationExecutor<MarketingReview> {
